...
CSV_OUTPUT=$HILP_HOME/experiments/example1/csvs/
...
TIMESTEP_RES=2.0 # Must best specified as float (e.g., 1.0 not 1)
...
###########################################################
# DZN output folder
DZN_FOLDER=$HILP_HOME/experiments/example1/dzns
...
###########################################################
# Example 1: Generate HILP Hello World
###########################################################
