...
CSV_OUTPUT=$HILP_HOME/experiments/example3/csvs/
...
# Number of unique benchmarks/applications in the workload (DON'T CHANGE UNLESS BENCHMARK COUNT CHANGES)
N_JOBS=10
...
###########################################################
# DZN output folder
DZN_FOLDER=$HILP_HOME/experiments/example3/dzns
...
###########################################################
# Example 3: Generate SoCs to explore the design space!
###########################################################
